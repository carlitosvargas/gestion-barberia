    ...
    <div className="home-page" style={{ padding: '4rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', justifyContent: 'center', maxWidth: '800px', margin: '0 auto' }}>
        <div className="glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
          ...
          <h3>Para Clientes</h3>
          <p style={{ margin: '1rem 0', color: 'var(--text-muted)' }}>Reserva tu turno de forma rápida y sencilla en tu barbería favorita.</p>
        ...
        <div className="glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
          ...
          <p style={{ margin: '1rem 0', color: 'var(--text-muted)' }}>Inicia sesión para gestionar tu barbería o administrar la plataforma.</p>
